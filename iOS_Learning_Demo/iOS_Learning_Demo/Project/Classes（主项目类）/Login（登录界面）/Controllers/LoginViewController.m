...
- (void)viewDidLoad {
    ...
    [mobileLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self.view.mas_centerY).offset(-40);
        make.right.mas_equalTo(self.view.mas_left).offset(120);
        make.height.mas_equalTo(13);
    }];
    mobileLabel.text = @"手机号";
    
    UITextField *mobileTextFiled = [[UITextField alloc] init];
    [self.view addSubview:mobileTextFiled];
    [mobileTextFiled mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    [mobileTextFiled layoutIfNeeded];
    ...
    [loginbutton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(mobileTextFiled.mas_right);
